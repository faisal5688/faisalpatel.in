var c01_m04_p04 = function() {
    ...
    var addEvents = function() {
        ...
        _imgs.bind("click", function() {
            c01_m04_p04.carousel.rotCarouse1(0);
    ...
    var addCarouselContent = function() {
        c01_m04_p04.carousel = $("#carousel").waterwheelCarousel({
            separation: 200,
            speed: 600,
            finalspeed: 600,
        });
...
function pageAudioHandler(currTime, totTime) {
    ...
    if (c01_m04_p04.playHead_new == seconds) {
        return;
    }
    c01_m04_p04.playHead_new = seconds;
