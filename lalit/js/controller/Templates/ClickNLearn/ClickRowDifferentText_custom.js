...
ClickRowDifferentText.initTabs=function(data){	
	...
	for(var t=0; t<ClickRowDifferentTextData.row_count; t++){
		...
		if(ClickRowDifferentTextData.row[t].clikable=="true"){
			ClickRowDifferentTextMC.find(".optText_part2").addClass("row");
...
ClickRowDifferentText.rowClicked=function(evt){
	$(".optText_part2").removeClass("rowvisited");
	$(this).addClass("rowvisited higlightVisited");
...
ClickRowDifferentText.markTabComplete=function(){
	//$("#optText_part2_"+ClickRowDifferentText.currentClickId).addClass("rowvisited");
