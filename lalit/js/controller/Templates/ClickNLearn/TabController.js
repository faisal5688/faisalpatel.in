...
TabObj_v1.isFofViewed = false;
TabObj_v1.pageViewd = false;
...
TabObj_v1.chkActivityCompletion = function(){
	...
	if(jQuery.inArray(0,TabObj_v1.tabVisitedArr) <= -1){	
		TabObj_v1.pageViewd = true;
		if(TabObj_v1.isFofViewed){
