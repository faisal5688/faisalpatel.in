...
ClickNLearn.tabClicked=function(evt){	
	...
	if(ClickNLearn.currentClickId != tabId){
		...
		Popup_01.showPopup(ClickData.clickItems[ClickNLearn.currentClickId-1].label_heading,"<div class='innerTxt'>"+ClickData.clickItems[ClickNLearn.currentClickId-1].content+"</div>");
