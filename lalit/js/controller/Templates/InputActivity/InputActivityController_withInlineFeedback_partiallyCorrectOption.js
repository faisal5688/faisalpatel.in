...
ActivityObj.maxCharLength=250;ActivityObj.partiallyCorrect=false;
var ActivityData;
...
ActivityObj.checkAnswer = function(){
	...
	ActivityObj.partiallyCorrect=true;
		ActivityObj.showFeedback(false);
	}
}
...
ActivityObj.showFeedback=function(result){
	...
	if(result){		
		...
		if(ActivityObj.partiallyCorrect==true){
			Feedback.showFeedback(ActivityData.feedback.partiallyCorrect.content);
		}else{
