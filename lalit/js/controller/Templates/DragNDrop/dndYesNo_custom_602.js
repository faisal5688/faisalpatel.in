...
DND_YesNo.init=function(data){	
	...
	SubmitButton.init($("#DNDContainer").find("#mcssSubmitBtn"));
	eventMgr.addControlEventListener(SubmitButton, "submitClicked", DND_YesNo.submitClicked);
...
DND_YesNo.submitClicked=function(evt){
	
	$(".clk_option").removeClass("selected");
	$(".clk_option").addClass("disabled");
	$(".clk_option").unbind('click');
	SubmitButton.chkSubmitEnable(false);
	$("#opt_2_1").addClass("correct");
	$("#opt_3_1").addClass("correct");
	$("#opt_4_1").addClass("correct");
	$("#opt_5_1").addClass("incorrect");
	$("#opt_6_1").addClass("correct");
	$("#opt_7_1").addClass("correct");
	$("#opt_8_1").addClass("incorrect");
	$("#opt_9_1").addClass("correct");
	$("#opt_10_1").addClass("correct");
	eventMgr.removeControlEventListener(SubmitButton, "submitClicked", DND_YesNo.submitClicked);
	m06_p01.onTemplateCompleted();
};
...
DND_YesNo.checkAnswer	=	function(evt){	
	...
	{
		$(this).removeClass("selected correct incorrect disabled visitedopt");
