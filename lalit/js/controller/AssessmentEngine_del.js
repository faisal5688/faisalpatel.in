...
assessmentEngine.startClicked = function() {
    ...
    $("a.screenshot").hide();
    if (String(ScormWrapper.courseObjectives[1].CompletionStatus).toLowerCase() != "completed") {
        ScormWrapper.setObjectivesCompletionStatus(1, "incomplete");
    };
...
assessmentEngine.showResultScreen = function() {
    ...
    if (assessmentEngine.userPercent >= assessmentEngine.passPercent) {
        ...
        //SCORMAPIService.setSuccessStatus("passed");
